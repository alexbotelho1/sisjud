...
/* $stmt = ociparse($conn,"begin sisjud.excluiInstrutor(:InUsuario, :InCodigo, :outresultado); end;"); */
/* $stmt = ociparse($conn,"begin sisjud.excluiInstrutor(:InUsuario, :Incpf,:Innome_agraciado,:Innome_al_conv,:Insetor_al_conv,:Incod_curso,:Innome_curso,:Inform_prof,:Inform_acad,:Incodigo,:Incargo,:Intit_classe,:Inposse,:Inexercicio,:Insetor,:Intit_funcao,:Inramal,:outresultado); end;"); */
  $stmt = ociparse($conn,"begin sisjud.excluiInstrutor(:InUsuario, :Incpf,:Innome_agraciado,:Innome_al_conv,:Insetor_al_conv,:Incod_curso,:Innome_curso,:Inform_prof,:Inform_acad,:outresultado); end;");
