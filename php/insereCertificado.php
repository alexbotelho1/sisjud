...
/* $stmt = ociparse($conn,"begin sisjud.insereCertificado(:InUsuario,:Incod_curso,:Incpf,:Innome_curso,:Innome_agraciado,:Innome_al_conv,:Insetor_al_conv,:Indt_inicio,:Indt_fim,:Incarga,:Inlocalidade,:Indt_exp,:outresultado); end;"); */
$stmt = ociparse($conn,"begin sisjud.insereCertificado(:InUsuario,:Incodigo,:Incod_curso,:Innome_curso,:Innome_agraciado,:Indt_inicio,:Indt_fim,:Incarga,:Inlocalidade,:Indt_exp,:Inassinatura,:outresultado); end;");
