...
<form action="aluno_add.php" method="post">
	...
	<td width="6%"> Nome de Aluno(a) do TRT da 14a. Região:<br>
		<input class="campo" type="text" id="alun_nome" name="alun_nome" size="80"/>
		<td width="6%"> Código:<br>
		<INPUT type="text" name="alun_codigo" id="alun_codigo" size="10" maxlength='6'></td>	
	</table>
	<table>						
...
<select name="alun_curso_id" id="alun_curso_id">
...
<right>(*) Preencher se o(a) Aluno <b>NÃO</b> for do TRT da 14a. Região</right><BR><P>

        <td width="2%"> CPF: (*)<br> 
		<input class="campo" type="text"  id="alun_conv_cpf" name="alun_conv_cpf" size="13" onKeyPress="return soNumero(event);" maxlength='11'/></td>
			
		<td width="6%"> Nome de Aluno(a) Convidado(a): (*)<br>
		<input class="campo" type="text" border="0" cellspacing="0" id="alun_conv_nome" name="alun_conv_nome" size="45" border="#FFFFFF" bgcolor="#FFFF00"/></td>	
		
		<td width="6%"> Local de Trabalho de Aluno(a) Convidado(a): (*)<br>
		<input class="campo" type="text" border="0" cellspacing="0" id="alun_conv_local" name="alun_conv_local" size="50" border="#FFFFFF" bgcolor="#FFFF00"/></td>
        ...
        <TABLE>		
			  ...
			  <select name="alun_form_prof" id="alun_form_prof">
				<option value=''></option>
			  ...
			  <select name="alun_form_acad" id="alun_form_acad">
				<option value=''></option>
