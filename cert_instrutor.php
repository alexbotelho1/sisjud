...
<iframe src="cert_lista_instrutor.php" marginwidth="1" marginheight="1" name="certificado_lista" width="980" height="200"></iframe>
...
<form action="cert_aluno_trt_add.php" method="post">
 ...
 <?php
$sql1 = "SELECT * FROM curso ORDER BY curso_nome ASC";
...
{
   echo "<option value='{$linha1['curso_nome']}'>{$linha1['curso_nome']}</option>";   
}
