...
$stmt = ociparse($conn,"begin pck_juntamed.InsereAtestado(:InUsuario, :InCdServ, :InCdMotAfast,:InDataIni, :InDataFim, :InSituacao, :InDataIniOp, :InDataFimOp, :InCdBaseLegal, :InCdCid, :OutResultado); end;");
