...
$modparecer = utf8_decode($modparecer);
$titulo = utf8_decode($titulo);
$parecer = utf8_decode($parecer);


$curs = ocinewcursor($conn);
$stmt = ociparse($conn,"begin rh.pck_juntamed.modelo_jmed_parecer(:InUsuario, :InModParecer, :InTitulo, :InParecer, :OutResultado); end;");
		ocibindbyname ($stmt,":InUsuario",$_SESSION["v_id"]);
		ocibindbyname ($stmt,":InModParecer",$modparecer);		
