...
<iframe src="cert_lista_aluno_conv.php" marginwidth="1" marginheight="1" name="certificado_lista" width="980" height="200"></iframe>

   <table>
		<caption> Expedição de Certificado - Participação de Aluno(a) em Curso Presencial:</caption>
	</table>

<form action="cert_aluno_conv_add.php" method="post">
	<table>	
...
if (@mysql_num_rows($resultado2) == 0)
   die('Nenhum registro encontrado');
?>
<select name="cert_conv_nome" id="cert_conv_nome">
    <option value='0' selected></option>
<?php 

while ($linha2=mysql_fetch_array($resultado2))
{
   echo "<option value='{$linha2['alun_conv_nome']}'>{$linha2['alun_conv_nome']}</option>";   
}
...
?>
	...
	<td width="6%"> Carga horária do curso:<br>
		...
		<br>
	    <!-- Insere as datas de início e término do curso -->
