...
<form action="imprimir1_add.php" method="post">
	<table>
...
?>
	...
	<table>						
			...
			<select name="cert_curso_nome" id="cert_curso_nome">
				...
				<option value='Curso de Formação de Brigada de Incêndio'> Curso de Formação de Brigada de Incêndio</option>
				...
				<option value='Curso de Pós-Graduação em Direito Eleitoral e Processo Eleitoral'> Curso de Pós-Graduação em Direito Eleitoral e Processo Eleitoral</option>
				<option value='Curso de Pós-Graduação - MBA em Direito e Processo do Trabalho'> Curso de Pós-Graduação - MBA em Direito e Processo do Trabalho</option>
  ...
  <tr>
    ...
    <td width="90">
        <select name="cert_dt_ini_mes" id="cert_dt_ini_mes">
			...
			<option value='Otubro'>Outubro</option>
...
<TABLE>
 <td>		
<!--
     <BR><center><input type="submit" id = "atualizar" value="Cadastrar" onClick="insereCertificado()"/></center><p><br>
-->
     <BR><center><input type=submit value=" Imprimir " style="background-position: center 50%; font-family:ADMUI3Sm; font-size:8 pt; color:#000000; font-weight:bold; background-repeat:no-repeat"></center><p><br>
</td>
</TABLE>
  ...
  <table>
	...
	<iframe name="mainFrame" width="860" marginwidth="0" height="110" marginheight="0" scrolling="auto" frameborder="0"></iframe>	
		...
		<li><a href="certificado.html"target="_self"> Menu Principal (Voltar <-)</a><p>
					
		<div id="rodape">
		<center>	&copy; 2009 - Secretaria de Tecnologia da Informação </center>
		</div> 
