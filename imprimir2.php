...
-->
     <BR><center><input type=submit onclick="MM_openBrWindow('imprimir1_add.php','','width=800,height=600,scrollbars=yes,menubar=yes')" value=" Imprimir " style="background-position: center 50%; font-family:ADMUI3Sm; font-size:8 pt; color:#000000; font-weight:bold; background-repeat:no-repeat"></center><p><br>
</td>
</TABLE>
</FORM>
</BODY>
